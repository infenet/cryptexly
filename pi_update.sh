...
FOR_OS=linux
FOR_ARCH=armv6
REL_URL=https://github.com/detroitcybersec/cryptexly/releases/latest
DEST_PATH=/home/pi/
...
ARCHIVE_URL="https://github.com/detroitcybersec/cryptexly/releases/download/$LATEST/$ARCHIVE_FILE"
CHECKSUMS_URL="https://github.com/detroitcybersec/cryptexly/releases/download/$LATEST/$CHECKSUMS_FILE"
...
echo "@ Stopping cryptexlyd ..."
sudo killall -9 cryptexlyd &>/dev/null

echo "@ Restarting ..."
rm -rf $DEST_PATH/*.log
sudo setcap 'cap_net_bind_service=+ep' $DEST_PATH/cryptexlyd
